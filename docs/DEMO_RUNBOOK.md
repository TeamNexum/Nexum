...
| **Bug volume Windows non fiable** | Le volume ne change pas sur PC A. | Lancer le **Diagnostic en lecture seule** dans l'onglet **Système** pour tester le périphérique audio, ou démontrer sous Linux (PC B) ; montrer les tests unitaires Core Audio en CI. | R08, BTP R3, QA §6.2 |
